...
export default function AdminLayout({ children }) {
  ...
  // Fetch User Profile Photo for Navigation Bars
  useEffect(() => {
    if (user?.uid) {
  ...
  const navigationGroups = [
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'New Event', href: '/admin/event', icon: CalendarCheck, colorClass: 'icon-red' },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Manage / Delete Offers', href: '/admin/offers/delete', icon: Trash2, colorClass: 'icon-red' },
      ]
    },
    {
      title: 'MEDIA & GALLERY',
  ...
  return (
    <div className="min-vh-100 d-flex admin-dashboard-container">
      ...
      >
        <div className="overflow-y-auto custom-scrollbar" style={{ maxHeight: 'calc(100vh - 90px)' }}>
      ...
      <div className="flex-grow-1 d-flex flex-column overflow-x-hidden">
        <header className="bg-white border-bottom p-2 d-flex align-items-center justify-content-between sticky-top z-3 shadow-sm">
          ...
          {/* Topbar Left Side: Mobile Home Icon & Desktop Collapse Button */}
          <div className="d-flex align-items-center gap-2">
            <Link
              href="/"
              className="btn btn-light rounded-circle p-2 text-dark border d-flex d-lg-none align-items-center justify-content-center"
          ...
          {/* Topbar Right Side */}
          <div className="d-flex align-items-center gap-2">
            <span className="badge bg-logo-orange text-white px-3 py-1.5 rounded-pill fw-bold fs-8">
              SYSTEM ONLINE
            </span>
            ...
            <Link
              href="/"
              className="btn btn-sm btn-outline-secondary rounded-pill px-3 py-1 fw-bold d-none d-sm-flex align-items-center gap-1.5"
      ...
      <div className="mobile-bottom-nav d-lg-none">
        ...
        {/* Post Button -> Points to Media Route */}
