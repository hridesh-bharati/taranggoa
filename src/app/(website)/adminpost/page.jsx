...
import { Heart, MessageCircle, Send, Loader2, Clock, Image as ImageIcon, Video, Grid, Trash2, Edit2, Check, X, Sparkles, TrendingUp, Users, Camera } from 'lucide-react';
...
export default function PublicFeedPage() {
  ...
  const [selectedMedia, setSelectedMedia] = useState(null); // 🌟 Added lightbox state
  ...
  // Get post counts for each filter
  ...
  return (
    <div className="min-vh-100" style={{ background: 'linear-gradient(135deg, #f8f9ff 0%, #f0f4ff 50%, #fff5f5 100%)' }}>
      ...
      <div className="container-fluid py-4 px-3 px-lg-5">
        {/* 🔥 Redesigned Colorful Header Topbar */}
        <div className="mb-5">
